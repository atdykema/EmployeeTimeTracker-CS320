...
async function getTimeData(req, res) {
    ...
    if (req.body.timeOption == "") {
        ...
        arr[req.body.employeeId] = 'yes';
        console.log(arr.reduce((a, e) => (a + (e === 'yes' ? 1 : 0)), 0) + " " + req.body.employeeId);
    }
...
router.post('/aggregateData', async (req, res, next) => {
    ...
    console.log("done with getting employee data");
    ...
    for (const data of timeData) {
        ...
        if (req.body.timeOption !== "" && req.body.startDate === undefined && req.body.endDate === undefined) {
        ...
        console.log(timeData.indexOf(data));
    }
